...
% hom_map: Enth�lt Nullen an Stellen, an denen eine homogene Fl�che
...
% R�nder f�llen und transponieren
% Linken Rand f�llen
...
% R�ckgabe der Disparity Map entsprechend des linken rektifizierten Bildformats
...
function [d_cor,line_hom] = SAD_line(line_number,L_R_base) % , min_cor
        ...
        % log_hom: Enth�lt Nullen an Stellen, an denen eine homogene Fl�che
        % detektiert wurde, sonst Einsen.
